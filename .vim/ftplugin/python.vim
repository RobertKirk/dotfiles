...
" mypy options
let b:ale_python_mypy_options = "--ignore-missing-imports --disallow-untyped-defs --warn-redundant-casts --warn-unused-ignores --warn-unreachable --allow-redefinition --show-error-codes"
