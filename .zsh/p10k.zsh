# Generated by Powerlevel10k configuration wizard on 2020-01-27 at 17:45 GMT.
...
# right frame, lightest, sparse, many icons, concise, transient_prompt,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%4F'   # blue foreground
      ...
      local      clean='%14F'  # grey foreground
      local   modified='%14F'  # grey foreground
      local  untracked='%14F'  # grey foreground
      local conflicted='%14F'  # grey foreground
    fi
